...
const Calendar = (props: Props) => {
    const { usage, className, setDateStatus, setIsModalOpen, setRecruitEndDate } = props;
    ...
    return (
        <section className={twMerge('bg-white border-[1px] border-gray3 rounded-[16px] p-2 pt-3', className)}>
                    ...
                    return (
                        <button
                            ...
                            onClick={() => {
                                ...
                                setRecruitEndDate(format(correctedDate, 'yyyy.MM.dd'));
                            ...
                            <div>
                                {/*오늘 style*/}
                                {today ? (
                                    <span className="rounded-[8px] border border-main py-2 px-3">{format(date, 'd')}</span>
                                ) : (
